...
class Test_compute_and_save_all(unittest.TestCase):
    ...
    def test_compute_and_save_nw_threshold_single_t(self,
        ...
        start_time = timer()
        compute_and_save_nw_threshold_single_t(sample_size, sample_size_to, sample_size_by, replication_count, mean, sigma, noise_type, t_par)
        end_time = timer() - start_time
    ...
    def test_compute_and_save_multi_precision_of_t(self,
        ...
        start_time = timer()
        compute_and_save_multi_precision_of_t(true_array, est_dict, x_label, x_array)
        end_time = timer() - start_time
