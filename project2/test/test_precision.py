...
class Test_precision_run(unittest.TestCase):
    ...
    def test_run_mse_array_by_array_and_double_array(self, true_array=[1,2,3],
        ...
        start_time = timer()
        returned = src.precision.mse_array_by_array_and_double_array(true_array=true_array,
    ...
    def test_run_bias_array_by_array_and_double_array(self, true_array=[1,2,3],
        ...
        start_time = timer()
        returned = src.precision.bias_array_by_array_and_double_array(true_array=true_array,
                                                                      est_double_array=est_double_array)
        duration = timer() - start_time
        print('Test parameters:')
        print('true_array = ', true_array)
