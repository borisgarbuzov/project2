...
class Test_create_noise(unittest.TestCase):
    def test_create_noise(self, noise_size=8, mean=5, sigma=0.12, noise_type= ["bernoulli","gaussian"]):
        ...
        for each in noise_type:
            ...
            returned = create_noise(noise_size=noise_size, mean=mean, sigma=sigma, noise_type=each)
