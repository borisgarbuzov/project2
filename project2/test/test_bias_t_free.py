...
class Test_bias_t_free(unittest.TestCase):
    def test_bias_t_free(self, true_value=5, est_double_array=np.array([1, 2, 3]), expected=-3.0):
        print('\n\n===============================================================================')
        print('Testing "bias_t_free"')
        start_time = timer()
        returned = bias_t_free(true_value=true_value, est_double_array=est_double_array)
